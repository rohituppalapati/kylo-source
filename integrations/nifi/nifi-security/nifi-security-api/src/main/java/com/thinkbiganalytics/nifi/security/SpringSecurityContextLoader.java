...
public class SpringSecurityContextLoader {
    ...
    public static SpringSecurityContextLoader create(@Nonnull final ApplicationContext applicationContext) {
    	...
    	final AbstractRefreshableConfigApplicationContext securityContext = new ClassPathXmlApplicationContext(applicationContext);
        securityContext.setClassLoader(SpringSecurityContextLoader.class.getClassLoader());
